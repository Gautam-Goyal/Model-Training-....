...
def setup_para(architect='vgg16',hidden_layer1 = 5024, learningr = 0.001, power='gpu'):
...
def train_network(model,criterion,device,train_loaders,valid_loaders,epochs = 12,learningr = 0.001):
...
def save_checkpoint(train_datasets,model,optimizer,path='trained_modelOO7.pth',architect='vgg16',epochs=12,learningr = 0.001):
